...
#define KIASKReturnKeyType					  @"ReturnKeyType"
...
#define kIASKReturnKeyDefault				@"Default"
#define kIASKReturnKeyGo					@"Go"
#define kIASKReturnKeyGoogle				@"Google"
#define kIASKReturnKeyJoin					@"Join"
#define kIASKReturnKeyNext					@"Next"
#define kIASKReturnKeyRoute					@"Route"
#define kIASKReturnKeySearch				@"Search"
#define kIASKReturnKeySend					@"Send"
#define kIASKReturnKeyYahoo					@"Yahoo"
#define kIASKReturnKeyDone					@"Done"
#define kIASKReturnKeyEmergencyCall			@"EmergencyCall"
...
#define kIASKTextLabelNumberOfLine                 @"IASKTextNumberOfLine"
